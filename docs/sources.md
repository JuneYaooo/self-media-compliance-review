...
- Xiaohongshu discussion search samples for `视频号 违规 限流 封号 虚假营销` and `视频号 封号 申诉 怎么办`, 2026-06-20: see `skills/self-media-compliance-review/references/cases/wechat-channels.md`.
...
- Xiaohongshu discussion search samples for `微信公众号 封号 申诉 怎么办`, 2026-06-20: see `skills/self-media-compliance-review/references/cases/wechat-official-account.md`.
...
- Xiaohongshu discussion search samples for `抖音 违规 封号 申诉 怎么办`, 2026-06-20: see `skills/self-media-compliance-review/references/cases/douyin.md`.
...
- Xiaohongshu discussion search samples for `快手 违规 封号 申诉 怎么办`, 2026-06-20: see `skills/self-media-compliance-review/references/cases/kuaishou.md`.
...
- Xiaohongshu discussion search samples for `B站 违规 小黑屋 申诉 怎么办` and `B站 小黑屋 处罚 公告 违规账号`, 2026-06-20: see `skills/self-media-compliance-review/references/cases/bilibili.md`.
...
- Xiaohongshu search/comment samples for `账号限流 怎么办`, `笔记违规 申诉`, and `薯管家 涉未成年人不良内容`, 2026-06-20: see `skills/self-media-compliance-review/references/cases/xiaohongshu.md`.
...
- Recent case index and cross-platform checklist: `skills/self-media-compliance-review/references/recent-cases-2025-2026.md`.
